...
-- Function: auto-create or link a customer when a lead is inserted/updated
...
DROP TRIGGER IF EXISTS trg_sync_lead_to_customer ON leads;
CREATE TRIGGER trg_sync_lead_to_customer
  BEFORE INSERT ON leads
  FOR EACH ROW
  EXECUTE FUNCTION sync_lead_to_customer();

-- Function: backfill all existing unlinked leads
