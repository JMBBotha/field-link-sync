-- Fix normalize_customer_contacts trigger function - references NEW.primary_phone but column is "phone"
...
-- Recreate sync_lead_to_customer with correct column names
...
-- Recreate backfill function with correct column names
