...
describe("write failures", () => {
  it("null addItem → ok:false message", async () => {
    const g = guardQuoteWrites({ addItem: async () => null, updateItem: async () => undefined, addArea: async () => null, updateArea: async () => undefined, deleteArea: async () => undefined, deleteItem: async () => undefined, moveItemToArea: async () => undefined });
