...
export const TERMS_BLOCKS: TermsBlock[] = [
  ...
  { type: "paragraph", text: "1.1 Should u the client feel comfortable in appointing us for your HVAC project, We, MassAir Ind cc, agree to provide air conditioning services as outlined in the quotation/estimate above." },
  ...
  { type: "paragraph", text: "2.4 All goods remain the property of MASSAIR IND cc until paid in full." },
  { type: "spacer", text: "" },
  ...
  { type: "paragraph", text: "5.2 Our service contract extends the manufacturer's warranty on the compressor to 5 years. If the compressor fails, we will install the replacement compressor free of charge. Please note that this warranty is only valid on new units supplied and installed by MASSAIR IND cc." },
  { type: "spacer", text: "" },

  { type: "heading", text: "Banking Details:" },
  { type: "banking", text: "6.1 Account Name: MASSAIR IND CC" },
  { type: "banking", text: "6.2 Bank: FNB" },
  { type: "banking", text: "6.3 Account Type: Cheque Account" },
  { type: "banking", text: "6.4 Account Number: 62326769075" },
  { type: "banking", text: "6.5 Branch Code: [250 655]" },
  { type: "spacer", text: "" },
