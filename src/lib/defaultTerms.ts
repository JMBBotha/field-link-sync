export const DEFAULT_TERMS = `MassAir Ind cc – Terms and Conditions for Quotations and Air Conditioning Services
...
3.1 Unless explicitly included in the quotation, electrical work (including connection to the distribution board/DB board) is excluded. Any required electrical upgrades or connections will be quoted separately.
...
4.1 Unless specifically itemized in the quotation, all building-related work is excluded. This includes chase cutting, core drilling, making good surfaces, plastering, painting, or any structural modifications.

4.2 Such work can be quoted separately if required.

5. Warranty

5.1 Standard warranty: 2 years on all moving parts and a 3-year manufacturer's warranty on the compressor (subject to compliance with service requirements).
