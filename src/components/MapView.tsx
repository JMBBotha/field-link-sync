...
const MapView = forwardRef<MapViewHandle, MapViewProps>(({ onStatusFiltersChange, onLeadClick, showAllAgents = false, hideChromeControls = false, hideStatusFilters = true, onStatusStateChange }, ref) => {
