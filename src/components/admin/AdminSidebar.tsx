...
const AdminSidebar = ({
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full bg-[#0077B6] dark:bg-slate-900">
      {/* Logo */}
      <div className={cn(
    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "hidden lg:flex h-full rounded-r-2xl bg-[#0077B6] dark:bg-slate-900",
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-[260px] transform transition-transform duration-300 lg:hidden rounded-r-2xl shadow-2xl border-r border-white/10 bg-[#0077B6] dark:bg-slate-900",
