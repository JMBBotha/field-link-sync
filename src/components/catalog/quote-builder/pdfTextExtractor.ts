...
// ============================================================
// This file contains the core PDF text extraction and product
// matching logic. It has been extensively tested and tuned for
// Samsung, Daikin, Midea, and One Stop Shop price lists.
//
// DO NOT:
// - Change any thresholds (0.15, 0.40, 0.55, 0.8, etc.)
// - Modify price detection regexes
// - Alter dedup logic or overlap margins
// - Change the mergeCurrencyWithPrices function
// - Modify matchTextRowsToProducts row processing
// - Remove or modify isHeaderOrNonProductRow filters
//
// If new functionality is needed, create a SEPARATE file and
// import/extend from this one. Do not edit this file directly.
// ============================================================
 ...
 *
 * v76 LOCKED: All thresholds and logic frozen after extensive testing.
 */
...
function buildProductLookup(products: PaletteProduct[]) {
  ...
  for (const p of products) {
    if (p.product_code) {
      ...
      // so PDF text missing the suffix still matches (Samsung /FA, Midea, Daikin)
