...
const Footer = ({ leftContent }: FooterProps) => {
  return (
    <footer 
      className="fixed bottom-0 left-0 right-0 z-30 px-4 py-2 flex items-center justify-between border-t bg-[#0077B6] dark:bg-gradient-to-r dark:from-[#070e1a] dark:via-[#153258]/90 dark:to-[#070e1a] border-[#006699] dark:border-[#153258]"
    >
